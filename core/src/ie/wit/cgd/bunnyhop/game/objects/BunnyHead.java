...
public class BunnyHead extends AbstractGameObject
{
	...
	public void setJumping(boolean jumpKeyPressed)
	{
		...
		case JUMP_FALLING: // Falling down after jump
			...
			if (jumpKeyPressed && hasCarrotPowerup && !hasFeatherPowerup && velocity.y < -2F)
			{
				timeJumping = 0;
				jumpState = JUMP_STATE.JUMP_RISING;
				setCarrotPowerup(false);
			}
			break;
		}
	}
	...
	public void setCarrotPowerup(boolean pickedUp)
	{
		hasCarrotPowerup = pickedUp;
	}

	public boolean hasCarrotPowerup()
	{
		return hasCarrotPowerup;
	}
	...
	protected void updateMotionY(float deltaTime)
	{
		...
		case JUMP_RISING:
			...
			else jumpState = JUMP_STATE.JUMP_FALLING;
		...
		case JUMP_FALLING:
			...
			{
				velocity.y -= terminalVelocity.y/10;
			}
		}
