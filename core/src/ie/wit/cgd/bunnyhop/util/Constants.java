...
public class Constants
{
	...
	public static final float VIEWPORT_WIDTH = 5.0f; // Visible game world is 5
														// meters wide
	public static final float VIEWPORT_HEIGHT = 5.0f; // Visible game world is 5
														// meters tall
	...
	public static final int LIVES_START = 3; // Amount of lives at the start of the game
												// start
